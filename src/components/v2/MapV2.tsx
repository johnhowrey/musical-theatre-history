...
const ACTIVE_CREATORS = [
  ...
  'James Lapine', 'Jason Moore', 'Jeff Calhoun', 'Jerry Zaks', 'Joe Layton',
  'Joe Mantello', 'John Rando', 'Josh Prince', 'Kelly Devine', 'Larry Fuller',
  'Larry Grossman', 'Lionel Bart', 'Lorin Latarro', 'Marc Shaiman',
  'Matthew Sklar', 'Mel Brooks', 'Michael Greif', 'Michael Kidd', 'Michael Korie',
  'Michael Mayer', 'Nicholas Hytner', 'Onna White', 'Patricia Birch', 'Peter Coe',
